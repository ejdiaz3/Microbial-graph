...
# # run vsp(doesn't look good if we use the Y directly..should do some subsetting, so that we are examining more interesint otus)
# library(vsp1)
# fa<-vsp(Y, k=20)
# plot_varimax_z_pairs(fa,1:10)#row(otu)
